...
改进前的 MCP 系统暴露了 48 个工具，完整覆盖功能域，但纯 MCP 使用者（Claude Desktop / Cursor / Windsurf）面临"零件箱，没有组装说明"的问题——工具列表是 API 目录，不是操作手册。
...
通过新增 `guide` 工具（11 个主题）+ 增强 12 个关键工具的描述，解决全部 15 项信息差。详见 [mcp_guide_completion.md](file:///E:/Code/loveMentor/readme/mcp_guide_completion.md)。
