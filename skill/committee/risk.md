...
### ② 需求感过强（Wiki 需求感控制原则）
Wiki 原则（docs/wiki/wiki/entities/需求感控制.md）：需求感 = 你让对方感觉到"你很想要她"。一旦暴露过多，吸引力归零。

- **Wiki 需求感三特征检查**：
  - 过度热情：秒回/主动发太多消息/过度使用表情包和感叹号
  - 讨好迎合：她说什么都说好/对/是的/放弃自己立场/过度夸赞
  - 过度敏感：她没回就追问"在吗"/她回慢了就焦虑/解读深层含义
- 检查草案是否过度暴露需求感（"我好想你"/"为什么不理我"/"你是不是不喜欢我了"）
- **Wiki 控制原则**：精简表达（字数越多需求感越强）+ 等值心态 + 70%频率法则
- **阶段加权**：
